    ...
    <body>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="<%=request.getContextPath()%>/ControladorBebidas?tipoc=${estados_contralador}" method="post" enctype="multipart/form-data">
                                    ...
                                    <tbody class="tbody_cuerpo table-group-divider">
                                        ...
                                        <c:forEach items="${datos}" var="item">   
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="<%=request.getContextPath()%>/img/${item.imagen}" width="100px" height="100px" alt="Actualización"/>
                                                </td>
                                                <td>${item.precio}</td>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                                        ...
                                                        <a href="<%=request.getContextPath()%>/ControladorBebidas?tipoc=${estados_contralador}&id=${item.id}&accion=delete" type="button" class="btn btn-warning" value="${item.id}">
        ...
        <script>
            function cargarDatos(id) {
                $.ajax({
                    url: '<%=request.getContextPath()%>/ControladorBebidas?tipoc=${estados_contralador}&accion=update&id=' + id,
                    method: 'GET',
                    success: function (data) {
                        $('#id').val(data.id);
                        $('#nombre').val(data.nombre);
                        $('#abastece').val(data.descripcion);
