    ...
    <body>
                ...
                <div class="sidebar-content js-simplebar">
                    ...
                    <ul class="sidebar-nav">
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul class="collapse show" id="dashboard-submenu8">
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="<%=request.getContextPath()%>/ControladorDetallePedido?tipoc=${estados_contralador}" method="post">

                                        <div class="mb-2">
                                            <label for="floatingSelect">Cliente</label>
                                            <select class="form-select" name="nombre2" id="nombre2" aria-label="Floating label select example">
                                                <option selected>--Selecciona--</option>
                                                <c:forEach items="${datosCliente}" var="item">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="<%=request.getContextPath()%>/ControladorDetallePedido?tipoc=${estados_contralador}" method="post">
                                        ...
                                        <div class="mb-2">
                                            <label for="floatingSelect">Cliente</label>
                                            <select class="form-select" name="nombre" id="nombre" aria-label="Floating label select example">
                                                <option selected>--Selecciona--</option>
                                                <c:forEach items="${datosCliente}" var="item">
                                                    <option value="${item.id}">${item.nombre}</option>
                                                </c:forEach>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                                        ...
                                                        <a href="<%=request.getContextPath()%>/ControladorDetallePedido?tipoc=${estados_contralador}&id=${item.id}&accion=delete" type="button" class="btn btn-warning" value="${item.id}">
        ...
        <script>
            function cargarDatos(id) {
                $.ajax({
                    url: '<%=request.getContextPath()%>/ControladorDetallePedido?tipoc=${estados_contralador}&accion=update&id=' + id,
                    method: 'GET',
                    success: function (data) {
                        $('#id').val(data.id);
                        $('#nombre').val(data.id_usuario);
                        $('#abastece').val(data.total);
