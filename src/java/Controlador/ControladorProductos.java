 ...
 * @author JEFFERSON
 */
@WebServlet(name = "ControladorP_Productos", urlPatterns = {"/ControladorP_Productos"})
public class ControladorProductos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("productos", prod.obtenerProductos());
        request.setAttribute("promociones", promo.obtenerProductos());
        request.setAttribute("bebidas", beb.obtenerProductos());
        request.setAttribute("complementos", comp.obtenerProductos());
